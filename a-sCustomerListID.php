...
<html>
<head>
<title>Customer List ID PHP</title>
...
<body style="background-color: #F8B0C4;">
<header>
...
<ul>
	...
	<br><br><h3 align="center">Customer Details</h3><br><br>
...
if($submit=="Submit")
{
    ...
    {        // create the query
               $orderID = $_POST["cariID"];
                 //$sql = "SELECT FROM pelajar WHERE Matrik LIKE %$Matrik%";
				 $sql = "SELECT * FROM customer WHERE orderID LIKE '%$orderID%' ";
                // execute query
			   ...
			   echo "<td bgcolor='#E5397F'><font face=georgia>Customer Name</font></td> ";
			   echo "<td bgcolor='#E5397F'><font face=georgia>Phone Number</font></td>";
			   echo "<td bgcolor='#E5397F'><font face=georgia>Date</font></td> ";
			   echo "</tr>";
			   
			   echo "<tr>";
			   echo "<td>$row[orderID] <br></td>";
               echo "<td>$row[customerName] <br></td>";
        	   echo "<td>$row[phoneNumber]<br></td>";
